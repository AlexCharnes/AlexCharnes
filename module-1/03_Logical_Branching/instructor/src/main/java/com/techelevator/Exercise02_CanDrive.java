...
public class Exercise02_CanDrive {
    ...
    public boolean canDrive(boolean hasPermit, boolean withLicensedPassenger, int passengerAge) {
        ...
        return false;
//        boolean isAllowedToDrive = canDrive(hasPermit, withLicensedPassenger);
//        if (isAllowedToDrive && passengerAge >= 21) {
//            return true;
//        }
//        return false;
    }
...
//
//        if (hasPermit && withLicensedPassenger && (passengerAge >= 21 || (passengerAge >= 18 && isPassengerOurGuardian))) {
//            return true;
//        }
//        return false;
    }
