...
String name = "TechElevator";
		...
		*/
		...
		your phone.
		*/
		int percentageOfBatteryLeftOnPhone = 89;
		/*
		...
		*/
		double numberOne = 12.3 + 32.1;
		/*
		12. Create a String that holds your full name.
		*/
		String myFullName = "Alex Charnes";
		/*
		13. Create a String that holds the word "Hello, " concatenated onto your
		name from above.
		*/
		String introduction = "Hello, " + myFullName;
		System.out.println(introduction);
		/*
		14. Add " Esquire" onto the end of your full name and save it back to
		the same variable.
		*/
		introduction = introduction + " Esquire";
		;
		/*
		15. Now do the same as exercise 14, but use the += operator.
		*/
		introduction += "Esquire";
		System.out.println(introduction);
		/*
		...
		*/
		double answerOne = 4.4 / 2.2;
		System.out.println(answerOne);
		/*
		19. What is 5.4 divided by 2?
		*/
		double answerTwo = 5.4 / 2;
		/*
		...
		*/
		long answer3 = (long) 1000000000 * 3;
