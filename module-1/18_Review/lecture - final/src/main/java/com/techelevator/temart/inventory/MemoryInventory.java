...
public class MemoryInventory implements Inventory {
    ...
    private void stockInventory() {
        ...
        Product clothing = new Clothing("C01", "T-shirt from Memory", 9.99, 1);
        Product grocery = new Grocery("G01", "Soup from Memory", 12.45, 6);
        Product homeGood = new HomeGood("H11", "Barbed Wire Lamp from Memory", 350.00, 30);
        Product book = new Book("B22", "First Aid for the Reckless from Memory", 19.99, 2 );
