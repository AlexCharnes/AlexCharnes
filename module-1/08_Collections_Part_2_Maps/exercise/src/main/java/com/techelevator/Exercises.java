...
public class Exercises {
    ...
    public String animalGroupName(String animalName) {
        ...
        newMap.put("elephant", "Herd");
        newMap.put("lion", "Pride");
        newMap.put("crow", "Murder");
        newMap.put("pigeon", "Kit");
        newMap.put("flamingo", "Pat");
        newMap.put("deer", "Herd");
        newMap.put("dog", "Pack");
    ...
    public Map<Integer, Integer> integerCount(int[] ints) {
        ...
        for (int number : ints){
            if (intCounts.containsKey(number)){
                intCounts.put(number, intCounts.get(number) + 1);
