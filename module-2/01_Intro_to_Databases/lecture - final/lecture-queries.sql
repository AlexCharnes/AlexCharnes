...
-- Get the same for cities NOT IN New England
SELECT city_name, area, population
FROM city
...
-- Can complex as needed where % represents any characters
SELECT city_name
FROM city
...
-- ILIKE is not case sensitive, but only works in PostgreSQL
SELECT city_name
FROM city
WHERE city_name ILIKE 'a%';

-- BETWEEN
-- Write a query to retrieve the names and areas of parks of at least 100 sq. kilometers 
-- but no more than 200 sq. kilometers
